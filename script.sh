...
# --- 系统信息检测函数 ---
get_system_info() {
    # 使用 tr -d '\r' 来清除系统命令输出中可能包含的隐藏回车符，增强兼容性
...
manage_backups() {
    ...
    local old_backups
    set +e # [终极修复] 暂时禁用 "exit-on-error" 模式
